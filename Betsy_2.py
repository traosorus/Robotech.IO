...
class BetsyGUI(object):
    ...
    def __init__(self):
        ...
        self.Betsy.setObjectName("Robotech IO")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Images/icons/icons/png/24/music/sound-wave@2x.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Images/pngwing.com (9).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
''')
    ...
    def retranslateUi(self):
        ...
        self.Betsy.setWindowTitle(_translate("self.Betsy", "Robotech IO"))
